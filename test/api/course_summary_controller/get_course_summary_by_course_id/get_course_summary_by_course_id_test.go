package get_course_summary_by_course_id
...
func TestGetCourseSummaryByCourseIdSuccess(t *testing.T) {
	...
	var courseSummaryResponse course.SummaryResponse
	...
	_ = mapstructure.Decode(responseBody.Data, &courseSummaryResponse)
	assert.NotNil(t, courseSummaryResponse.Id)
	assert.NotNil(t, courseSummaryResponse.CourseId)
	assert.NotNil(t, courseSummaryResponse.DocURL)
}

func TestGetCourseSummaryByCourseIdFailedInvalidToken(t *testing.T) {
	e := di.InitializedEchoServerForTest()
...
func TestGetCourseSummaryByCourseIdFailedCourseNotFound(t *testing.T) {
	e := di.InitializedEchoServerForTest()
