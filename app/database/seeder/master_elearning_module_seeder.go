...
func InitElearningModuleData() []entity.MasterElearningModule {
	return []entity.MasterElearningModule{
		...
		//#Module Intro to Marketing
		{
			...
			ModuleTitle: "Title 1",
			ModuleOverview: sql.NullString{
				String: "Alami Pembelajaran langsung dari para expertnya dan memiliki pemahaman baru tentang Marketing.",
				Valid:  true,
			},
			ModuleDescription: sql.NullString{
		...
		//#Module Intro to Creative
		{
			...
			ModuleTitle: "Title 1",
			ModuleOverview: sql.NullString{
				String: "Alami Pembelajaran langsung dari para expertnya dan memiliki pemahaman baru tentang Creative.",
				Valid:  true,
			},
			ModuleDescription: sql.NullString{
